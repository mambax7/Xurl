...
function Xurl_QR($pad,$sleutel,$d,$e,$s,$v,$t,$n,$m,$p,$o)
{

$path=XOOPS_ROOT_PATH."/modules/Xurl/class/qr/data";           /* You must set path to data files. */
$image_path=XOOPS_ROOT_PATH."/modules/Xurl/class/qr/image";    /* You must set path to QRcode frame images. */
$version_ul=40;              /* upper limit for version  */  
/* ------ setting area end ------ */


$qrcode_data_string=@$d;
$qrcode_error_correct=@$e;
$qrcode_module_size=@$s;
$qrcode_version=@$v;
$qrcode_image_type=@$t;
...
$qrcode_structureappend_originaldata=@$o;
...
if ($qrcode_image_type == "jpeg"){
    ImageJpeg($output_image,($pad."qr_".$sleutel.".jpg"));
} else {
    ImagePng($output_image,($pad."qr_".$sleutel.".png"));
}
