...
$modversion['name'] = _MI_XURL_NAME;
$modversion['version'] = "1.2";
$modversion['description'] = _MI_XURL_DESC;
$modversion['author'] = "Designburo.nl";
$modversion['credits'] = "Designburo.nl";
$modversion['help'] = "license.html";
$modversion['license'] = "OPEN PUBLIC LICENSE";
$modversion['official'] = 0;
$modversion['image'] = "images/xurl.png";
$modversion['dirname'] = "Xurl";
$modversion['releasedate'] = "Thursday, 10th of September 2009";
...
$modversion['tables'][0] = "xurl";

//install
$modversion['onInstall'] = 'functions/module.php';

$modversion['onUpdate'] = 'functions/module.php';

// Templates
//$modversion['templates'][1]['file'] = 'admin_main.html';
//$modversion['templates'][1]['description'] = '';

// Config

// Blocks
$modversion['blocks'][1]['file'] = "xurl_block.php";
$modversion['blocks'][1]['name'] = _MI_XURL_BLOCK_NAME;
$modversion['blocks'][1]['description'] =_MI_XURL_BLOCK_INFO;
$modversion['blocks'][1]['show_func'] = "blockList";
$modversion['blocks'][1]['template'] = 'xurl_block.html';

$modversion['blocks'][2]['file'] = "xurl_block.php";
$modversion['blocks'][2]['name'] = _MI_XURL_BLOCK_TWITNAME;
$modversion['blocks'][2]['description'] =_MI_XURL_BLOCK_TWITINFO;
$modversion['blocks'][2]['show_func'] = "showTwit";
$modversion['blocks'][2]['template'] = 'xurl_twit_block.html';

$modversion['blocks'][3]['file'] = "xurl_block.php";
$modversion['blocks'][3]['name'] = _MI_XURL_BLOCK_FORM_NAME;
$modversion['blocks'][3]['description'] =_MI_XURL_BLOCK_FORM_INFO;
$modversion['blocks'][3]['show_func'] = "showform";
$modversion['blocks'][3]['template'] = 'xurl_post_block.html';

$modversion['blocks'][4]['file'] = "xurl_block.php";
$modversion['blocks'][4]['name'] = _MI_XURL_BLOCK_QR_NAME;
$modversion['blocks'][4]['description'] =_MI_XURL_BLOCK_QR_INFO;
$modversion['blocks'][4]['show_func'] = "showQR";
$modversion['blocks'][4]['template'] = 'xurl_QR_block.html';
